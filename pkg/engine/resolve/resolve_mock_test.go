...
// Source: github.com/drovatar/graphql-go-tools/pkg/engine/resolve (interfaces: DataSource,BeforeFetchHook,AfterFetchHook,DataSourceBatch,DataSourceBatchFactory)
...
import (
	context "context"
	fastbuffer "github.com/drovatar/graphql-go-tools/pkg/fastbuffer"
