...
import (
	...
	"github.com/drovatar/graphql-go-tools/pkg/graphql"
	"github.com/drovatar/graphql-go-tools/pkg/playground"

	http2 "github.com/drovatar/graphql-go-tools/examples/federation/gateway/http"
)
